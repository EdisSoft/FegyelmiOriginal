  ...
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        A fegyelmi jogkör gyakorlója a közvetítői eljárást lezárta. Az
        elkülönítést
        <em
          >{{ mockNaplo.Elrendelo | camelCaseString }}
          {{ mockNaplo.ElrendeloRendfokozat }}</em
        >
        felülvizsgálta.
      </a>
    </div>
...
export default {
  name: 'fegyelmi-elkulonites-felulvizsgalata-naplo-bejegyzes',
  data() {
    return {
      mockNaplo: {
        EljarasEredmenye: 'Garancia teljesült',
        Elrendelo: 'János',
        ElrendeloRendfokozat: 'vitéz',
      },
    };
  },
  mounted() {},
