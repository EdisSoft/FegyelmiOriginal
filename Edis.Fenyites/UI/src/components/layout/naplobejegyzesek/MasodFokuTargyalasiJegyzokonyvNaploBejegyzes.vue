          ...
          <div class="col col-12 mt-10">
            <div class="float-right ml-10 mb-10 d-flex">
              ...
              <b-button
                ...
                :disabled="isModalOpen"
                type="button"
                @click="MasodFokuTargyalsiJegyzokonyvNyomtatas"
...
export default {
  name: 'masod-foku-targyalasi-jegyzokonyv-naplobejegyzes',
  data() {
    return {
  ...
  methods: {
    ...
    MasodFokuTargyalsiJegyzokonyvNyomtatas() {
    ...
    NaploBejegyzesSzerkesztes() {
      ...
      eventBus.$emit('Modal:jegyzokonyv-masodfokutargyalasi', {
        state: true,
        data,
      });
    },
  ...
  computed: {
    ...
    fejlec() {
      ...
      if (
        ...
        Cimkek.NaploTipus.MasodfokuTargyalasiJegyzokonyv
      ) {
        return 'A II. fokú tárgyalás jegyzőkönyve rögzítésre került.';
      }
      return '';
    },
  },
