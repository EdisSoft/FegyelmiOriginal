  ...
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        <em>{{ naplobejegyzes.DonteshozoSzemely | camelCaseString }}</em>
        elrendelte az eljárás lefolytatását, melyet
        <em>{{ naplobejegyzes.KivizsgaloSzemely | camelCaseString }}</em>
        vizsgál ki. Határidő:
        {{ naplobejegyzes.Hatarido | toShortDate }}
      </a>
    </div>
...
export default {
  name: 'ugy-elrendelese-naplobejegyzes',
  data() {
    return {};
  },
  mounted() {},
