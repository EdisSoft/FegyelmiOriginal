  ...
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        Az I. fokú tárgyalás "<em>{{
          naplobejegyzes.HatarozatHozoJogkoreCimke
        }}</em
        >" jogkörben
        <em>{{ naplobejegyzes.ElsofokuTargyalasIdopontja | toDateTime }}</em
        >-kor kerül tárgyalásra.
      </a>
    </div>
...
export default {
  name: 'elso-foku-targyalas-kituzese-naplo-bejegyzes',
  data() {
    return {};
  },
  mounted() {},
