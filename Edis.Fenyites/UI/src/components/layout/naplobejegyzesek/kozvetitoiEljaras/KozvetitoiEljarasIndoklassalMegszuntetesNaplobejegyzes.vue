  ...
  <div class="panel" v-if="fegyelmiUgy && naplobejegyzes">
    <div class="panel-heading" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        A fegyelmi jogkör gyakorlója megszüntette a közvetítői eljárást.
        Megszüntetés oka: <em>{{ naplobejegyzes.MegszuntetesOkaCimke }}</em
        >.
      </a>
    </div>
...
export default {
  name: 'kozvetitoi-eljaras-indoklassal-megszuntetes-naplobejegyzes',
  data() {
    return {
      toolTipOptions: {
