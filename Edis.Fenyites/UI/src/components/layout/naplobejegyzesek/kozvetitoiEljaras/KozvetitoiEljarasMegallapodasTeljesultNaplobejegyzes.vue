  ...
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      <a
        ...
        v-b-toggle="panelId"
        ><span v-if="naplobejegyzes.GaranciaTeljesultFl == true">
          A közvetítői eljárás keretében vállalt megállapodás határidőre
          teljesült.
        </span>
        <span v-else
          >A közvetítői eljárás keretében vállalt megállapodás határidőre nem
          teljesült.</span
        >
      </a>
    </div>
...
export default {
  name: 'kozvetitoi-eljaras-megallapodas-teljesult-naplobejegyzes',
  data() {
    return {};
  },
  mounted() {},
