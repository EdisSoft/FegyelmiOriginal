  ...
  <div class="panel" v-if="fegyelmiUgy && naplobejegyzes">
    <div class="panel-heading" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        A közvetítői eljárás határideje módosult. Új határidő:
        <em>{{ naplobejegyzes.Hatarido | toShortDate }}</em>
      </a>
    </div>
...
export default {
  name: 'kozvetitoi-eljaras-hatarido-modositas-naplobejegyzes',
  data() {
    return {
      toolTipOptions: {
      ...
      mockNaplo: {
        KozvetitoiEljarasHatarido: moment().toISOString(),
      },
    };
  },
  mounted() {},
