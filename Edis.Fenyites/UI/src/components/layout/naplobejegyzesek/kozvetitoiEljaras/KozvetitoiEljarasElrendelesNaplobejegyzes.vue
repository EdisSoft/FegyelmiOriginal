  ...
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        <span v-if="naplobejegyzes.Visszautasitva">
          A fegyelmi jogkör gyakorlója a közvetítői eljárás lefolytatását
          megtagadta.
        </span>
        <span v-else>
          A fegyelmi jogkör gyakorlója elrendelte a közvetítői eljárás
          lefolytatását, melyet
          <em
            >{{ naplobejegyzes.JegyzokonyvVezetoSzemely }}
            {{ naplobejegyzes.JegyzokonyvVezetoSzemelyRendfokozat }}</em
          >
          közvetítőnek kell lefolytatnia
          <em>{{ naplobejegyzes.Hatarido | toShortDatePontNelkul }}-ig</em>.
        </span>
      </a>
    </div>
...
export default {
  name: 'kozvetitoi-eljaras-elrendeles-naplobejegyzes',
  data() {
    return {};
  },
  mounted() {},
