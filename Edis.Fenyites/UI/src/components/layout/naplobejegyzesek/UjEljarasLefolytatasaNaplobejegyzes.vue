  ...
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      <a
        ...
        v-b-toggle="panelId"
      >
        A másodfokú határozat szerint az eljárást újra le kell folytatni.
        Előzmény ügy: {{ naplobejegyzes.ElozmenyUgyAzonosito }}
      </a>
    </div>
...
export default {
  name: 'uj-eljaras-lefolytatasa-naplobejegyzes',
  data() {
    return {};
  },
  mounted() {},
