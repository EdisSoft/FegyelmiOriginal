<template>
  <div class="panel" v-if="naplobejegyzes">
    <div class="panel-heading" :id="panelId" role="tab">
      ...
      >
        <span>
          Fenyítés végrehajtása megkezdődött
          {{ naplobejegyzes.LetrehozasDatuma | toDateTime }}-kor.
        </span>
      </a>
    </div>
    <div class="text-right pl-20 pb-0">
      <small class="blue-grey-400">
        {{ naplobejegyzes.TipusCimke }} · Rendszer ·
...
export default {
  name: 'automatikus-vegrehajtas-megkezdes-naplobejegyzes',
  data() {
    return {};
  },
  mounted() {},
