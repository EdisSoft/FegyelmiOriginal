    ...
    <div class="modal-grey">
      <div class="modal-header">
        ...
        <h4 class="modal-title">
          24. Szabadszöveges naplóbejegyzés
        </h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        >
          ...
          Naplóbejegyzés rögzítése</b-button
        >
      </div>
    </div>
  </basic-loader>
...
export default {
  name: 'szabadszoveges-naplobejegyzes-rogzitese',
  data: function() {
    return {
      isFormLoading: false,
      title: 'Szabadszöveges bejegyzés',
      isLoading: false,
      fegyelmiUgyIds: [],
      formData: {
  ...
  methods: {
    ...
    LoadFormData: async function(fegyelmiUgyIds, naplobejegyzesIds) {
      ...
      try {
        ...
        var result = { Leiras: '' };
        result = await apiService.GetFegyelmiNaplobejegyzesSzerkeszteseModalData(
          {
    ...
    SaveFormData: async function() {
      try {
        ...
        result = await apiService.SzabadszovegesFegyelmiNaplobejegyzesFelvitele(
          { data }
        );

        NotificationFunctions.SuccessAlert(
          'Szabadszöveges naplóbejegyzés',
          'A naplóbejegyzés mentése sikerült'
        );
        ...
        NotificationFunctions.AjaxError({
          title: 'Hiba',
          text: 'Naplóbejegyzés mentése sikertelen',
          errorObj: err,
        });
        console.log(err);
      }
