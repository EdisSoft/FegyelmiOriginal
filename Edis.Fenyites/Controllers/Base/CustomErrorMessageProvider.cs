...
namespace Edis.Fenyites.Controllers.Base
{
    public class CustomErrorMessageProvider
    {
            ...
            public static void SetResourceClassKey(string resourceClassKey)
            {
                ...
                ModelBinderErrorMessageProviders.ValueRequiredErrorMessageProvider = CustomErrorMessageProvider.DefaultValueRequiredErrorMessageProvider;
                ModelBinderErrorMessageProviders.TypeConversionErrorMessageProvider = CustomErrorMessageProvider.DefaultTypeConversionErrorMessageProvider;
            }
