...
namespace Edis.ViewModels.JFK.FENY
{
    ...
    public class KioktatasReintegraciosTisztiJogkorbenViewModel
    {
        ...
        public string VegrehajtasFoka { get; set; }
        public string Elhelyezes { get; set; }
        public string FoglalkozasText { get; set; }
        public string Hely { get; set; }
        public int? Ev { get; set; }
        public int? Honap { get; set; }
        public int? Nap { get; set; }
        public string FoglalkozastTartotta { get; set; }
