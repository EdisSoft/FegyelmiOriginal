...
namespace Edis.ViewModels.JFK.FENY
{
    ...
    public class EsemenyResztvevoPanelViewModel
    {
        public int FogvatartottId { get; set; }
        public string FogvatartottNev { get; set; }
        public int ErintettsegFokaCimId { get; set; }
        public string ErintettsegFokaNev { get; set; }
        ...
        public string FegyelmiUgyszam { get; set; }
    }
}
